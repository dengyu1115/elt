package com.nature.elt.index.mapper;
...
public class KlineMapper {
    ...
    public int batchMerge(List<Kline> list) {
        SqlParam param = SqlParam.build().append("REPLACE INTO kline(").append(COLUMNS).append(")VALUES ")
    ...
    public List<Kline> list(String code, String market) {
        SqlParam param = SqlParam.build().append("select").append(COLUMNS).append("from kline")
    ...
    public List<Kline> list(String code, String market, String dateStart, String dateEnd) {
        SqlParam param = SqlParam.build().append("select").append(COLUMNS).append("from kline where")
    ...
    public List<Kline> listByDate(String date) {
        SqlParam param = SqlParam.build().append(SQL_QUERY_DATE, date);
        return baseDB.list(param, mapper);
    }
    ...
    public void delete() {
        baseDB.executeUpdate(SqlParam.build().append("delete from kline"));
    }
