...
import com.nature.elt.common.mapper.ItemGroupMapper;
import com.nature.elt.common.model.Item;
import com.nature.elt.common.model.ItemGroup;
...
public class ItemGroupManager {
    ...
    public List<Item> listAllIndexes() {
        return this.listItem(DefaultGroup.INDEX.getCode());
    }

    public List<Item> listAllFunds() {
        return this.listItem(DefaultGroup.FUND.getCode());
    }
