package com.nature.kline.common.http;
...
import com.nature.kline.common.util.HttpUtil;
...
public class KlineHttp {
    ...
    private static final String URL_KLINE = "http://push2his.eastmoney.com/api/qt/stock/kline/get?secid=%s.%s" +
            "&fields1=f1,f2,f3,f4,f5&fields2=f51,f52,f53,f54,f55,f56,f57&klt=101&fqt=0&beg=%s&end=%s";
    /**
     * CHARSET
     */
    ...
    private Kline genKline(JSONObject jo) {
        ...
        kline.setScale(TextUtil.getDouble(jo.getString("f21")));
        return kline;
    }
